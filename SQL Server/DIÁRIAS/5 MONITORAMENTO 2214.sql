...
SELECT A.IDCNT, CODIGOCONTRATO, CODCFO, DATACONTRATO, DATAINICIO, DATAFIM, CODSTACNT, VALORCONTRATO, CODVEN, NOME, CODDEPARTAMENTO, B.DT_CONTRATO INTO #TCNT FROM CorporeRM.TCNT A
